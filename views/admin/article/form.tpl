...
{{template "admin/copyright.tpl" .}}
{{template "admin/common-js.tpl" .}}
{{template "admin/form-js.tpl" .}}
{{template "admin/write-js.tpl" .}}
{{template "admin/editor-js.tpl" .}}
{{template "admin/file-upload-js.tpl" .}}
